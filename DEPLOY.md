...
1. **Перший провал** — «📤 Share with a friend · +1 shield». У справжньому Mini App `tg.openTelegramLink()` відкриває нативне вікно поширення Telegram **не закриваючи гру** (на відміну від класичних Games). Оскільки Telegram не дає callback «повідомлення реально надіслано», нагорода видається за стандартною евристикою: коли гравець повертається у застосунок після відкриття вікна поширення.
